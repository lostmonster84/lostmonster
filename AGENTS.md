...
│   ├── AGENTS.md     # ← Website-specific AI instructions
...
│   ├── AGENTS.md     # ← Framework AI instructions
...
│   └── ...
│
└── AGENTS.md         # This file (repo overview)
```
...
npm run dev
```
**Read:** [website/AGENTS.md](./website/AGENTS.md) for design system and guidelines.
...
|--------|---------|------------|
| `website/` | Lost Monster marketing site | [website/AGENTS.md](./website/AGENTS.md) |
...
**If working on the website:** Read [website/AGENTS.md](./website/AGENTS.md) first.

**If using framework templates:** Read [framework/AGENTS.md](./framework/AGENTS.md) first.
