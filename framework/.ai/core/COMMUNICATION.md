...
This will help visitors connect with the people behind Native Automotive.
...
**Good**:
```
"Refactored animation timing to use naturalEase constant (Porsche-precision
easing) instead of hardcoded values"
```
