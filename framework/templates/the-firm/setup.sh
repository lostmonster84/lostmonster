...
# ══════════════════════════════════════════════════════
# THE FIRM — Setup Script
# 24 workers. 1 Gaffer. Automated quality gates.
# ══════════════════════════════════════════════════════
#
# Usage:
#   cd your-project
#   bash /path/to/the-firm/setup.sh
#
# What it does:
...
#   4. Cleans up template originals
...
# Where this script lives (the-firm/ directory)
...
echo ""
echo -e "${BOLD}══════════════════════════════════════════════════${NC}"
echo -e "${BOLD}  THE FIRM — Quality Orchestration Setup${NC}"
echo -e "${BOLD}  24 workers. 1 Gaffer. Drop in and go.${NC}"
echo -e "${BOLD}══════════════════════════════════════════════════${NC}"
echo ""
...
if [ "$SCRIPT_DIR" = "$PROJECT_DIR" ]; then
    echo -e "${RED}Error: You're running this from inside the-firm/ template directory.${NC}"
...
# Copy crew/ (all 24 workers + GAFFER)
...
echo ""
echo -e "${BOLD}══════════════════════════════════════════════════${NC}"
echo -e "${GREEN}  THE FIRM is installed.${NC}"
echo -e "${BOLD}══════════════════════════════════════════════════${NC}"
echo ""
...
echo "      │   ├── planners/   (5 workers)"
echo "      │   ├── builders/   (6 workers)"
echo "      │   ├── reviewers/  (6 workers)"
echo "      │   └── checkers/   (7 workers)"
echo "      └── gaffer/"
echo "          ├── session-log.md"
echo "          ├── debts.md"
echo "          ├── calibration.md"
...
echo ""
echo -e "${BOLD}The Firm is ready. Let's go.${NC}"
echo ""
