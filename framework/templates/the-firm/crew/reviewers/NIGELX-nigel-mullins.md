...
| **Character** | [TEST-PERSONA] — not tech-savvy, impatient, closes the tab if confused. Has never read a tooltip in his life. Doesn't know what a "pipeline" is. Calls everything "the website" |
...
**NIGELX for [PROJECT]** understands:
- [TEST-PERSONA] doesn't know what [entity-primary] means — they have a word for it already
...
- [PROJECT-DOMAIN] may be unfamiliar to first-time visitors — jargon kills comprehension
...
**Checkpoints:**
- [ ] **One clear primary action per screen** — There's one thing Nigel should do on this page, and it's visually obvious. Secondary actions exist but don't compete. If Nigel can't tell what the main thing is within 3 seconds, there are too many competing elements
...
**Framework Status:** [PROJECT] Edition — Full Playbook (promoted from light worker)
**Last Updated:** February 2026
**Version:** 1.0 ([PROJECT] Edition — INSPX Checkpoint Mode)
