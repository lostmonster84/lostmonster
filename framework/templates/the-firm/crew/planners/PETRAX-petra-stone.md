...
**PETRAX for [PROJECT]** validates plans against:
...
- [PROJECT-DOMAIN] domain complexity ([BUSINESS-LOGIC-KEY], trust signals, multi-entity relationships)
- Phase 1 [entity-geo] ([entity-geo-1], [entity-geo-2], [entity-geo-3])
- PRD principles (core UX rules specific to [PROJECT])
- Design system constraints (`[DESIGN-GUIDE-PATH]`, approved backgrounds, card-on-canvas)
...
- [ ] No subjective criteria without specifics ("looks good" → "matches [DESIGN-GUIDE-PATH] card treatment: bg-white rounded-2xl shadow")
...
```
PETRAX VALIDATION: [TARGET-USER-B] [entity-primary] Dashboard
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  Completeness: FAIL — No empty state for [entity-primary] table when [TARGET-USER-B] has zero [entity-primary]
