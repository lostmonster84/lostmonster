# UXPATX — Standard UX Patterns — [PROJECT] Edition

> **Pat Stencil: Chief Patterns Officer**
> "There's a pattern for that."
> Member of The Firm
>
> Mandatory UX patterns for any admin or dashboard interface. Non-negotiable standards.
> **Usage:** Reference when building ANY list, table, form, or CRUD interface.
...
export async function POST(request: Request) {
  ...
  // Upload to your storage ([OBJECT-STORAGE], S3, etc.)
