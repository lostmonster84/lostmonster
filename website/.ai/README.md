...
- [CODA Planning Framework](../.ai-framework/.ai/frameworks/coda.md) - Planning methodology (template)
- [Design Variations Workflow](../.ai-framework/.ai/frameworks/design-variations.md) - 5 variations approach (template)
- [Development Principles](../.ai-framework/.ai/core/DEVELOPMENT-PRINCIPLES.md) - Core principles (universal)
- [Standard Workflow](../.ai-framework/.ai/core/WORKFLOW.md) - Development workflow (universal)
- [Communication Guidelines](../.ai-framework/.ai/core/COMMUNICATION.md) - How to communicate (universal)
- [Framework Map](../.ai-framework/.ai/frameworks/FRAMEWORK-MAP.md) - All 16 frameworks & when to use them
...
│   └── ...                                      # Other docs
│
└── ../.ai-framework/                            # Universal framework (78 files)
    ├── README.md                                # Framework overview
    ├── START-HERE.md                            # Quick orientation
    ├── .ai/                                     # AI development framework
    │   ├── core/                                # Universal principles
    │   ├── frameworks/                          # 16 planning frameworks
    │   └── standards/                           # Enterprise standards
    ├── .claude/agents/                          # 4 AI agents
    ├── agents/project-spin-up/                  # Project bootstrap agent
    ├── integrations/                            # Service integration guides
    └── utilities/                               # Dev utilities & scripts
```
...
- Use [CODA planning](../.ai-framework/.ai/frameworks/coda.md) template
- Create [5 design variations](../.ai-framework/.ai/frameworks/design-variations.md)
