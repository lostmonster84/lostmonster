...
1. **Plan with CODA** (for complex features - see [.ai-framework/.ai/frameworks/coda.md](.ai-framework/.ai/frameworks/coda.md))
2. **Create 5 variations** (if design decision - see [.ai-framework/.ai/frameworks/design-variations.md](.ai-framework/.ai/frameworks/design-variations.md))
...
- [Design Variations](.ai-framework/.ai/frameworks/design-variations.md) - 5 variations approach
- [Development Principles](.ai-framework/.ai/core/DEVELOPMENT-PRINCIPLES.md) - Core principles
